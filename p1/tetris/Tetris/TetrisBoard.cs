public class TetrisBoard
{
    ...
    public TetrisBoard(TetrisGameState gameState)
    {
        Board = TetrisGameState.ListBoardToLinkedList(gameState.Board);
        ColorBoard = TetrisGameState.ListColorBoardToColorBoard(gameState.ColorBoard);
