public class TetrisGameState
{
    ...
    public TetrisGameState(int playerId, string playerName, int level, int score, int totalLineCleared, Coordinate currentPos, Shape currentShape, Shape nextShape, List<List<char>> board, List<List<Color>> colorBoard)
    {
        PlayerId = playerId;
